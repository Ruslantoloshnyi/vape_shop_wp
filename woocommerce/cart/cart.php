		...
		<tbody>
			...
			?>
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
						...
						<td class="product-thumbnail busket-image">
							<?php
						...
						<td class="busket-product-name" data-title="<?php esc_attr_e('Product', 'woocommerce'); ?>">
							<?php
							if (!$product_permalink) {
						...
						<td class="busket-product-price" data-title="<?php esc_attr_e('Price', 'woocommerce'); ?>">
							<?php
